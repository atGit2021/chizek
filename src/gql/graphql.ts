...
export type ForumFragmentFragment = { __typename?: 'Forum', _id: string, name?: string | null, userId: string, isPrivate: boolean, userIds: Array<string>, messages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any, ownerId: string }> };
...
export type CreateForumMutation = { __typename?: 'Mutation', createForum: { __typename?: 'Forum', _id: string, name?: string | null, userId: string, isPrivate: boolean, userIds: Array<string>, messages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any, ownerId: string }> } };
...
export type ForumQuery = { __typename?: 'Query', forum: { __typename?: 'Forum', _id: string, name?: string | null, userId: string, isPrivate: boolean, userIds: Array<string>, messages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any, ownerId: string }> } };

export type ForumsQueryVariables = Exact<{ [key: string]: never; }>;


export type ForumsQuery = { __typename?: 'Query', forums: Array<{ __typename?: 'Forum', _id: string, name?: string | null, userId: string, isPrivate: boolean, userIds: Array<string>, messages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any, ownerId: string }> }> };
...
export const ForumDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"forum"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"_id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"forum"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"_id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ForumFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ForumFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Forum"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"isPrivate"}},{"kind":"Field","name":{"kind":"Name","value":"userIds"}},{"kind":"Field","name":{"kind":"Name","value":"messages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"ownerId"}}]}}]}}]} as unknown as DocumentNode<ForumQuery, ForumQueryVariables>;
